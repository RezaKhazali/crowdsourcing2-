"""
Django settings for crowd_sourcing project.
...
SECRET_KEY = 'w+9=%i+_a4815)tf#eesze_z$_cuqm70y@m%mc62#7ks(a6qda'
...
ROOT_URLCONF = 'crowd_sourcing.urls'
...
WSGI_APPLICATION = 'crowd_sourcing.wsgi.application'
